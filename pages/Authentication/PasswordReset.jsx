  ...
  return (
    <div className="w-full min-h-screen flex flex-col bg-gradient-to-br from-blue-50 to-cyan-50">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16">
        <div
          className="bg-white border-2 border-solid border-black w-full max-w-md rounded-2xl shadow-[0px_4px_4px_#00000040] opacity-0 translate-y-[-1rem] animate-fade-in"
